...
import { createBeforeAndAfterColoration  } from '../../../actions/bAaColoration';
import { useNavigate,Link } from 'react-router-dom';

const ColorationForm = ({createBeforeAndAfterColoration}) => {
  ...
  async function handleOnSubmit(e) {
    ...
    await createBeforeAndAfterColoration(formData,navigate);
    setTitre('');
    setPhoto1(null);
    setPhoto2(null);
  }
...
ColorationForm.propTypes = {
  createBeforeAndAfterColoration:PropTypes.func.isRequired,
}

export default connect(null,{createBeforeAndAfterColoration}) (ColorationForm)
